...
Mac üzerinde Node.js, Rust veya geliştirme ortamı gerekmez. [Folio macOS DMG](https://github.com/ogttuna/LibraryOrganizer/actions/workflows/macos-release.yml) iş akışının başarılı çalışmasından **apple-silicon** paketini indir. ZIP'i aç, içindeki DMG'yi açıp Folio'yu **Uygulamalar** klasörüne sürükle.
...
Node.js 24, Rust 1.95 ve [Tauri sistem bağımlılıkları](https://v2.tauri.app/start/prerequisites/) gerekir. Bu çalışma ortamında kurulu.
